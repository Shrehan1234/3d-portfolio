...
let projects = [
  {
    image: 'textures/project-suvidha.jpg',
    url: 'https://suvidhafoundations.netlify.app/',
  },
  {
    image: 'textures/project-videoCalling.jpg',
    url: '',
  },
  {
    image: 'textures/project-pianoTiles.jpg',
    url: 'https://shrehan-piano-tiles.netlify.app/',
  },
  {
    image: 'textures/project-tictac.jpg',
    url: 'https://shrehan1234.github.io/tic-tac-toe/',
  },
];
let aboutCameraPos = {
  x: 0.12,
...
function loadIntroText() {
  ...
  loader.load('fonts/unione.json', function (font) {
    ...
    const titleGeo = new TextGeometry('Shrehan Das', {
      font: font,
      size: 0.08,
      height: 0.01,
    });
